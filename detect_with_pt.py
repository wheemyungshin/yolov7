...
def detect(save_img=False):
    ...
    # Load model
    model_person = attempt_load('weights/fisheye_v0.pt', map_location=device)  # load FP32 model
    ...
    names = ['car', 'person']#model.module.names if hasattr(model, 'module') else model.names
