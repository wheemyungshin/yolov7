...
if __name__ == '__main__':
    fd_model = tf.lite.Interpreter("../onnx2tf/saved_model/modified_DU_ciga_mobilenet_v2_e089_no_opt_192_192_full_integer_quant.tflite")
    ...
    while True :
        ...
        if frame is not None:
            ...
            crop_img = crop_img.astype(np.int8)
            ...
            one_time_gap = time.time()-one_time
            print("one time : ", one_time_gap)
            total_time += one_time_gap
            frame_count += 1
        else:
            break
    
    print("full time : ", time.time() - start_time)
    print("avg time : ", total_time / frame_count)