...
def train(hyp, opt, device, tb_writer=None):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if epoch == epochs - opt.close_mosaic:
            ...
            is_distill = False
        for close_dg in opt.close_data_generation:
            if epoch == close_dg:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--close-data-generation', nargs='+', type=int, default=[300], help='stop mosaic augmentation and distillation')
