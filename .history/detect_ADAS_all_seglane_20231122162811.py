...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        if vid_path != save_path:  # new video
            last_light_length = 120
            last_lights = ['Nolight']*last_light_length
            warn_status = {
                'last_light' : 'Nolight',
        ...
        if dataset.mode != 'image' and frame % frame_ratio != 0:
            ...
            for i, det in enumerate(pred):  # detections per image
                ...
                if warn_status['last_light'] == 'Red' and warn_status['speed'] > 10:
                    warn_status['ignore_light'] = True
                else:
                    warn_status['ignore_light'] = False
