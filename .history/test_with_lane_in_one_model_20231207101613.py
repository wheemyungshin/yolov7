...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes, masks) in enumerate(tqdm(dataloader)):
        ...
        for si, pred in enumerate(out):
            ...
            # 예측 결과를 이미지로 저장 준비
            os.makedirs('/data/small_ticket_testset_addition_ready/segmentation/vis_images', exist_ok=True)
            ...
            cv2.imwrite('/data/small_ticket_testset_addition_ready/segmentation/vis_images/'+str(path.resolve()).split('/')[-1], vis_img)            
