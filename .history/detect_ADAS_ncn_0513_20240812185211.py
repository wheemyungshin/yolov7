                    ...
                    for temp_box_id, (*xyxy, conf, cls) in enumerate(det[:, :6]):
                        ...
                        if save_img or view_img:  # Add bbox to image
                            ...
                            if opt.debug:
                                ...
                                roi_polygon = [
                                    img_shape_bef_crop[1]*0.2, 0,
                                    img_shape_bef_crop[1]*0.8, 0,
                                    img_shape_bef_crop[1]*0.5, img_shape_bef_crop[0]*0.3                                    
                                ]
                                is_in_polygon(img_shape_bef_crop[1:], roi_polygon, point)
                                if 960 - 300 < (xyxy[0]+xyxy[2])/2 < 960 + 300:
