                        ...
                        if temp_box_id in valid_idx:
                            ...
                            for prev_frame_idx in range(max_prev_frame,0,-1):
                                if len(prev_boxes_list) >= prev_frame_idx and len(prev_box_ids) >= prev_frame_idx and \
                                    len(prev_boxes_list[max_prev_frame-prev_frame_idx] > prev_box_ids[max_prev_frame-prev_frame_idx]):
                                    x1_list.append(prev_boxes_list[max_prev_frame-prev_frame_idx][prev_box_ids[max_prev_frame-prev_frame_idx]][0])
                                    y1_list.append(prev_boxes_list[max_prev_frame-prev_frame_idx][prev_box_ids[max_prev_frame-prev_frame_idx]][1])
                                    x2_list.append(prev_boxes_list[max_prev_frame-prev_frame_idx][prev_box_ids[max_prev_frame-prev_frame_idx]][2])
                                    y2_list.append(prev_boxes_list[max_prev_frame-prev_frame_idx][prev_box_ids[max_prev_frame-prev_frame_idx]][3])
                                else:
