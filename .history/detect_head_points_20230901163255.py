                ...
                if len(det):
                    ...
                    for xyxy_person in det[det[:, -1] == 0, :4]:
                        ...
                        for xyxy_head in det[det[:, -1] == 1, :4]:
                            ...
                            is_in_head = check_box_in_box(xyxy_head_np, xyxy_person_np, 5)
                            if is_in_head:
                                is_in_head_all == True
                        if not is_in_head_all:
                            valid_head_list.append(np.array[[xyxy_person_np[0],
                                    xyxy_person_np[1],
                                    xyxy_person_np[2],
                                    (xyxy_person_np[1]*2 + xyxy_person_np[3])/3]])
                    ...
                    tl = 15
                    conf = str("Head Count: ", str(len(valid_head_list)))
