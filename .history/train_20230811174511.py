    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _, masks) in pbar:  # batch -------------------------------------------------------------
            ...
            if opt.qat:
                ...
                if opt.seg:
                    loss, loss_items = compute_loss_seg(pred, targets.to(device), masks=masks.to(device).float(), valid_segment_labels=valid_segment_labels, update_seg_loss=update_seg_loss)  # loss scaled by batch_size
