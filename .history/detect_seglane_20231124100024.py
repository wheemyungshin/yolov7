...
def detect(save_img=False):
    ...
    if opt.seg:
        if len(opt.valid_segment_labels) > 0:
            ...
            nm = len(names)+1
        seg_colors = [[255, 100, 100], [100, 255, 255], [255, 100, 255], [255, 100, 100], [100, 255, 255], [255, 100, 255],
            [255, 100, 100], [100, 255, 255], [255, 100, 255], [255, 100, 100], [100, 255, 255], [255, 100, 255],
            [255, 100, 100], [255, 100, 100], [100, 255, 255], [255, 100, 255]]
