                    ...
                    for *xyxy, conf, cls in reversed(det[:, :6]):
                        ...
                        if cls == 1:#head only
                            ...
                            for size_ratio_div_idx in range(len(bbox_num_per_size.keys())-1):
                                if sorted(bbox_num_per_size.keys())[size_ratio_div_idx+1] < head_size < sorted(bbox_num_per_size.keys())[size_ratio_div_idx]:
                                    bbox_num_per_size[int(head_size/1000)*1000]+=1
