...
def output_matching(model2_input, fd_output):
    
    if fd_model2.get_input_details()[0]["shape"][1] == fd_output_0_0_.shape[1]:
        fd_output_0_0 = fd_output_0_0_
    elif fd_model2.get_input_details()[0]["shape"][1] == fd_output_0_1_.shape[1]:
        fd_output_0_0 = fd_output_0_1_
    elif fd_model2.get_input_details()[0]["shape"][1] == fd_output_0_2_.shape[1]:
        fd_output_0_0 = fd_output_0_2_
    else:
        print("wrong input shape: ", fd_model2.get_input_details()[0]["shape"])
...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes, _) in enumerate(tqdm(dataloader, desc=s)):
        ...
        print(fd_model2.get_input_details()[1]["shape"], fd_output_0_1_.shape)
        print(fd_model2.get_input_details()[2]["shape"], fd_output_0_2_.shape)
