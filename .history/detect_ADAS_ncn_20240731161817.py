...
def prev_weighted_value(prev_values, temp_value, max_prev_frame):
    temp_weight_ratio = 0.7
    sum([prev_boxes_list[-prev_frame_idx][0]*((max_prev_frame-prev_frame_idx+1)/(max_prev_frame*(max_prev_frame+1)/2)) 
                                    for prev_frame_idx in range(max_prev_frame,0,-1)])*0.3 + temp_value*temp_weight_ratio
                ...
                if len(det):
                    ...
                    for temp_box_id, (*xyxy, conf, cls) in enumerate(det[:, :6]):
                        ...
                        if temp_box_id in valid_idx:
                            ...
                            prev_weighted_value(prev_boxes_list[-prev_frame_idx][0], xyxy[0], max_prev_frame)
                            xyxy = np.array([sum([prev_boxes_list[-prev_frame_idx][0]*((max_prev_frame-prev_frame_idx+1)/(max_prev_frame*(max_prev_frame+1)/2)) 
                                    for prev_frame_idx in range(max_prev_frame,0,-1)])*0.3 + xyxy[0].detach().cpu().float()*0.7,
                                    sum([prev_boxes_list[-prev_frame_idx][1]*((max_prev_frame-prev_frame_idx+1)/(max_prev_frame*(max_prev_frame+1)/2)) 
                                    for prev_frame_idx in range(max_prev_frame,0,-1)])*0.3 + xyxy[1].detach().cpu().float()*0.7,
                                    sum([prev_boxes_list[-prev_frame_idx][2]*((max_prev_frame-prev_frame_idx+1)/(max_prev_frame*(max_prev_frame+1)/2)) 
                                    for prev_frame_idx in range(max_prev_frame,0,-1)])*0.3 + xyxy[2].detach().cpu().float()*0.7,
                                    sum([prev_boxes_list[-prev_frame_idx][3]*((max_prev_frame-prev_frame_idx+1)/(max_prev_frame*(max_prev_frame+1)/2)) 
                                    for prev_frame_idx in range(max_prev_frame,0,-1)])*0.3 + xyxy[3].detach().cpu().float()*0.7])
                        else:
