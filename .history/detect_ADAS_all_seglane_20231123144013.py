...
def detect(save_img=False):
    ...
    print(imgsz)
    if opt.splice_inference:
        dataset = LoadImages(source, img_size=(imgsz[0]*2, imgsz[1]*2), stride=stride)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--splice-inference', action='store_true', help='slice inference')
