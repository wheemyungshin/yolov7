...
class ComputeLossSegment:
    ...
    def __call__(self, preds, targets, masks, valid_segment_labels, imgs):  # predictions, targets, model
        p, proto = preds
        ...
        for bi in range(bs):
            ...
            cv2.imwrite('test_vis_semantic_imgs/'+str(np.mean(vis_img))+'.jpg', imgs[bi].detach().cpu().numpy(), (1,2,0)*255)
