    ...
    def __getitem__(self, index):
        ...
        if mosaic:
            ...
            if hyp is not None and 'distortion' in hyp: 
                img, labels = random_distortion(img, labels, (h, w), k1_range=hyp['distortion'][0], k1_range=hyp['distortion'][1])
...
def load_mosaic(self, hyp, index):
    ...
    for i, index in enumerate(indices):
        ...
        if hyp is not None and 'distortion' in hyp: 
            img, labels = random_distortion(img, labels, (h, w), hyp['distortion'])
