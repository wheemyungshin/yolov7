...
def load_image_and_label(self, index, ratio_maintain=True, min_label_size_limit=None, max_label_size_limit=None, hyp=None):
    ...
    if img is None:  # not cached
        ...
        img, labels = natural_minmax_crop(img, labels, min_label_size_limit, max_label_size_limit)
