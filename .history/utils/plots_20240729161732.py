...
def plot_images(images, targets, paths=None, fname='images.jpg', masks=None, names=None, max_size=640, max_subplots=16):
    ...
    mosaic = np.full((int(ns * h), int(ns * w), 3), 0, dtype=np.uint8)  # init
