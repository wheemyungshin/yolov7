...
def detect(save_img=False):
    ...
    old_img_b = 1
        ...
        os.makedirs(os.path.join(results, 'vis_frames'), exist_ok=True)
        os.makedirs(os.path.join(results, 'images'), exist_ok=True)
        os.makedirs(os.path.join(results, 'mask_npy'), exist_ok=True)
        os.makedirs(os.path.join(results, 'mask_npy', 'lane'), exist_ok=True)
        os.makedirs(os.path.join(results, 'mask_npy', 'drivable_area'), exist_ok=True)
