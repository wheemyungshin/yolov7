...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # prev tracking
        left_xyxy = [l_item*0.3 + prev_l_item*0.7 for l_item, prev_l_item in zip(left_xyxy, prev_left_xyxy)]
        right_xyxy = [r_item*0.3 + prev_r_item*0.7 for r_item, prev_r_item in zip(right_xyxy, prev_right_xyxy)]
