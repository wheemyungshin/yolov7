...
if __name__ == '__main__':
    ...
    if opt.cfg and opt.nc:
        ckpt_weights = torch.load(opt.weights, map_location=map_location)  # load checkpoint
        ...
        model = attempt_load_v2(opt.weights, ckpt, map_location=device)  # load FP32 model
    else:
