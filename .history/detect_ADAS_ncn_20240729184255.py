                    ...
                    for temp_box_id, (*xyxy, conf, cls) in enumerate(det[:, :6]):
                        ...
                        if temp_box_id in valid_idx:
                            ...
                            for prev_frame_idx in range(max_prev_frame,0,-1):
                                ...
                                distance_weights.append(prev_distance*((max_prev_frame-prev_frame_idx+1)/(max_prev_frame+1)))
                        ...
                        if save_img or view_img:  # Add bbox to image
                            ...
                            if opt.debug:
                                ...
                                label = distance_str
                                for all_prev_distance in all_prev_distances:
                                    label = label + str(all_prev_distance) +'_'
