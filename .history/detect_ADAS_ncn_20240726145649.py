...
CAMERA_ANGLE_WEIGHT = math.tan(CAMERA_LENS_ANGLE*math.pi/180/2)*2 # 57 -> 1.0859113992768736
...
def calculate_distance(cxywh, resolution):
    ...
    distance = (OVERALL_HEIGHT_DICT[c]) / (pixel_ratio) / CAMERA_ANGLE_WEIGHT # 거리 (m)
