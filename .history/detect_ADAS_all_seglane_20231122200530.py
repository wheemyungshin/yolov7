...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        if vid_path != save_path:  # new video
            ...
            lane_ongoing_lefts = [[None]*150, [None]*150]
            prev_gray = None
        ...
        if dataset.mode != 'image' and frame % frame_ratio != 0:
            ...
            if largest_mask is not None:
                ...
                if on_left is not None:
                    ...
                    lane_ongoing_lefts
                    for ongoing_left_idx in range(len(lane_ongoing_lefts)-1):
                        lane_ongoing_lefts[ongoing_left_idx] = lane_ongoing_lefts[ongoing_left_idx+1]
                    lane_ongoing_lefts[-1] = [on_left, going_left]
