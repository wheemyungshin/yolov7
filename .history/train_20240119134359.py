...
if __name__ == '__main__':
    ...
    parser.add_argument('--merge-label', type=int, nargs='+', help='file list')
    parser.add_argument('--merge-label', type=str, nargs='+', action='append', help='file list')
    parser.add_argument('--merge-label', nargs='+', type=int, default=[], help='Freeze layers: backbone of yolov7=50, first3=0 1 2')
