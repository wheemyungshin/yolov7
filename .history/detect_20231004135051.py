...
def detect(save_img=False):
    ...
    bbox_num_per_size = {}
    for size_ratio_div in range(0,50):
        bbox_num_per_size[size_ratio_div/100] = 0
                ...
                if len(det):
                    ...
                    for *xyxy, conf, cls in reversed(det[:, :6]):
                        ...
                        if cls == 1:#head only
                            ...
                            for size_ratio_div_idx, size_ratio_div in enumerate(bbox_num_per_size.keys()):
                                if bbox_num_per_size.keys()[size_ratio_div_idx] < head_size < bbox_num_per_size.keys()[size_ratio_div_idx+1]:
                                    bbox_num_per_size[bbox_num_per_size.keys()[size_ratio_div_idx]]+=1
